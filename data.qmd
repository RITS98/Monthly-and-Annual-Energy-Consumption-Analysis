...
### 3.1. Loading the Monthly Energy Data

```{r}
energy_df_monthly <- read_xlsx(path = "data.xlsx", sheet=1, skip=9)
energy_df_monthly <- energy_df[-1, ]
...
### 3.2. Loading the Annual Energy Data

```{r}
energy_df_annual <- read_xlsx(path='data.xlsx', sheet=2, skip=9)
